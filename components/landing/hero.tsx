      ...
      <div className="container mx-auto">
        <div className="flex gap-8 py-20 lg:py-40 items-center justify-center flex-col">
          <div className="flex gap-4 flex-col">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl max-w-3xl tracking-tighter text-center font-bold">
              <span className="text-foreground">Ask questions about</span>
            ...
            <p className="text-lg leading-relaxed tracking-tight text-muted-foreground max-w-xl text-center mx-auto">
              Get precise, cited answers — each one linked to its source.
            </p>
          </div>
